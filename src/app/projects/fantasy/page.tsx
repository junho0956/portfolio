  ...
  return (
    <>
      ...
      <div className={styles.subDesc}>
        ...
        <br/>
        <span>
          Typescript, Next.js, Redux-toolkit, constate, Styled-components<br/>
          GCP - CE + nginx + pm2<br/>
      ...
      <div className={styles.subDesc}>
        ...
        <ul>
          ...
          <li>
            ...
            <div>초기에는 PC 사용자를 주력으로 개발했으나 Google Analytics 기준 80%의 점유율이 Mobile 인 것으로 확인되어 반응형 UI 구현에 집중하였습니다.</div>
          ...
          <li>
            ...
            <div>
              그래서 서비스에 필요하다고 판단되는 기능들을 모방하여 직접 커스텀 훅을 개발하고 프로젝트 전체에 적용하였습니다.
            </div>
            <div>
          ...
          <li>
            ...
            <div>추가적으로 Modal, Toast 와 같은 공통 컴포넌트를 개발하였습니다.</div>
          </li>
          <li>
